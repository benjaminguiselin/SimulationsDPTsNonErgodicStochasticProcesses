...
The script ./compute_ldf_residence_time.py computes the analytical solution for the large deviation rate function (./Analytics/ldf_residence_time_theory.txt) and the sgcf (./Analytics/scgf_residence_time_theory.txt).
The gnuplot script ./plot_ldf_residence_time.gp generates Fig. 7 from the files ./Data/ldf_residence_time.txt, ./Analytics/ldf_residence_time_theory.txt and ./Analytics/scgf_residence_time_theory.txt.